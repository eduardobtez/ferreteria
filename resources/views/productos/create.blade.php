...
<form action="{{ route('productos.store') }}" method="POST" novalidate>
    ...
    <div class="mb-3">
        ...
        <input type="number" id="cantidad_actual" name="cantidad_actual" value="{{ old('cantidad_actual') }}" class="form-control @error('cantidad_actual') is-invalid @enderror" required min="0">
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" id="precio_venta" name="precio_venta" value="{{ old('precio_venta') }}" class="form-control @error('precio_venta') is-invalid @enderror" required min="0">
        @error('precio_venta')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" id="precio_compra" name="precio_compra" value="{{ old('precio_compra') }}" class="form-control @error('precio_compra') is-invalid @enderror" required min="0">
        @error('precio_compra')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" id="porcentaje_utilidad" name="porcentaje_utilidad" value="{{ old('porcentaje_utilidad') }}" class="form-control @error('porcentaje_utilidad') is-invalid @enderror" required min="0">
    ...
    <div class="mb-3">
        ...
        <select id="rela_proveedor" name="rela_proveedor" class="form-select @error('rela_proveedor') is-invalid @enderror" required>
            ...
            <option value="{{ $proveedor->id_proveedores }}" {{ old('rela_proveedor') == $proveedor->id_proveedores ? 'selected' : '' }}>
    ...
    <div class="mb-3">
        ...
        <input type="number" id="cantidad_minima" name="cantidad_minima" value="{{ old('cantidad_minima') }}" class="form-control @error('cantidad_minima') is-invalid @enderror" required min="0">
