...
<form action="{{ route('proveedores.store') }}" method="POST" novalidate>
    ...
    <div class="mb-3">
        ...
        <input type="text" id="razon_social" name="razon_social" value="{{ old('razon_social') }}" class="form-control @error('razon_social') is-invalid @enderror" required maxlength="250">
        @error('razon_social')
    ...
    <div class="mb-3">
        ...
        <input type="text" id="telefono_contacto" name="telefono_contacto" value="{{ old('telefono_contacto') }}" class="form-control @error('telefono_contacto') is-invalid @enderror" required maxlength="250">
    ...
    <div class="mb-3">
        ...
        <input type="text" id="persona_contacto" name="persona_contacto" value="{{ old('persona_contacto') }}" class="form-control @error('persona_contacto') is-invalid @enderror" required maxlength="250">
